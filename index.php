...
<body>
	...
	<div class="homepageContainer">
		<div class="homepageFeatures">
			<div class="homepageFeature">
				...
				<p class="featureDiscription">blahblahblah</p>
			</div>
    ...
    <div class="homepageNotified">
    	<div class="homepageContainer">
    		<div class="homepageNotifiedContainer">
    			<div class="emailForm">
				<h3>Notified if there is any update!</h3>
				<p>ydfjhfgddjhgkhfgdfhjh
				fyhggkhg,kgjhkj,ghhkgkhghdydfh
			    gfjhgkhjhljhljlkjkjkj</p>
			    <form action="">
			    ...
			    <div class="video">
				<iframe src="https://www.youtube.com/48VkVOHYGWw"  frameborder="0"></iframe>
			    </div>
    		</div>
    	</div>
	</div>
	<div class="socials">
		<div class="homepageContainer">
			...
			<p class="socialText">gjhjsgdifdfugdkhdbdhgyudfvhvdkh</p>
		</div>
